...
<div class="back_link">
    <a href="#" onclick="window.history.back()"><?php _e('Back', 'expresspay') ?></a>
</div>
...
<form class="payment_setting_save_page" id="payment_setting_save_page" method="post" action="<?php echo osc_esc_html(osc_route_admin_url('expresspay-admin-options-save', array('id' => expresspay_get_options_id()))); ?>">
    ...
    <div class="row">
        ...
        <div class="col-md-7">
            <input type="text" id="payment_setting_notification_url" value="<?php echo osc_esc_html($notif_url); ?>" readonly />
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-offset-5 col-md-7">
            <input class="button-blue button-action" type="submit" value="<?php _e('Save', 'expresspay') ?>">
            <input class="button-orange button-action" style="margin-left: 4px;" type="button" onclick="window.location.href='<?php echo osc_esc_html($url . '?page=payment-settings-list'); ?>'" value="<?php _e('Cancel', 'expresspay') ?>">
        </div>
    </div>
</form>
